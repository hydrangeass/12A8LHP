...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Nhiệt huyết của chúng mình " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Lưu ý nho nhỏ cho chúng mình:';
document.querySelector('.Description .modal-body').innerHTML = 'Đỉnh vinh quang đón người ham học - Đáy vực thẳm đợi kẻ ham chơi <i class="fas fa-heart"></i> ';
